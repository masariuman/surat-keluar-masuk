...
<br>
<div>
	{!! Form::label('alamat_penerima', 'Alamat Penerima :', ['class' => 'control-label']) !!}
	{!! Form::text('alamat_penerima', null, ['class' => 'form-control']) !!}

  @if($errors->has('alamat_penerima'))
    <span><i><b><font color="red">{{$errors->first('alamat_penerima')}}</font></b></i></span><br>
  @endif
</div>
<br>
